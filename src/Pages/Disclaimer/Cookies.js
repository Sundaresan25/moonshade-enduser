    ...
    <div className="bg-white min-h-screen py-16 px-4 md:px-8 lg:px-16 text-gray-800 font-fahkwang">
      <div className="max-w-5xl mx-auto space-y-10 mt-16">
        ...
        <div className="space-y-6">
          <h2 className="text-2xl font-bold text-black font-bodoni">What Are Cookies?</h2>
          ...
          <h2 className="text-2xl font-bold text-black font-bodoni">How We Use Them</h2>
          ...
          <h2 className="text-2xl font-bold text-black font-bodoni">How to Manage Cookies</h2>
          <p className="text-lg text-gray-700">
