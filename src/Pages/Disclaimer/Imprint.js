    ...
    <div className="bg-white min-h-screen py-16 px-4 md:px-8 lg:px-16 text-gray-800 font-fahkwang">
      <div className="max-w-5xl mx-auto space-y-10 mt-16">
        ...
        <div className="space-y-6">
          <h2 className="text-2xl font-bold text-black font-bodoni">{t('companyInformation')}</h2>
          <p className="text-lg text-gray-700">
            <strong>{t('companyName')}:</strong> MOONSHADE Fragrances Ltd.<br />
            <strong>{t('address')}:</strong> 123 Essence Avenue, Aroma City, 10001<br />
            <strong>{t('email')}:</strong> contact@moonshade.com
          </p>

          <h2 className="text-2xl font-bold text-black font-bodoni">{t('representatives')}</h2>
          <p className="text-lg text-gray-700">
            {t('representedBy')}
          </p>

          <h2 className="text-2xl font-bold text-black font-bodoni">{t('disputeResolution')}</h2>
          <p className="text-lg text-gray-700">
            {t('disputeText')}
          </p>
        </div>
